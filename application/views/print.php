<div class="container-fluid">
    <div class="row justify-content-center mt-5">
        <div class="col-md-5">
            <div class="card">
                <div class="card-body"> 
                    <div style="width: 75px; aspect-ratio: 4/3; margin: auto;">
                    <img src="<?= base_url("assets/favicon.png") ?>" alt="" style="width: 100%; height: 100%; object-fit: contain; object-position: center;">
                </div>
